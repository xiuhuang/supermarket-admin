  ...
  columns: StandardTableColumnProps[] = [
    {
      title: '产品编号',
      dataIndex: 'no',
      render: v => <Link to={`/organize/product/info/detail/${v}`}>{v}</Link>,
    },
    {
      title: '产品名称',
      dataIndex: 'name',
    ...
    },
    {
      ...
      render: (text, record: any) => (
        <Fragment>
          {record.status === 1 && (
            <>
              <Button>上架</Button> <Button>删除</Button>
            </>
          )}
          {record.status === 2 && <Button>下架</Button>}
          {record.status === 3 && <Button>送审</Button>}
        </Fragment>
      ),
    },
  ];
