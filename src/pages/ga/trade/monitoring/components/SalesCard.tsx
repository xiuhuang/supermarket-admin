...
const rankingListData: { title: string; total: number }[] = [
  { title: '建设银行-抵押快贷', total: 3570 },
  { title: '农业银行-苏微贷', total: 954 },
  { title: '南京银行-小微e贷', total: 831 },
  { title: '农业银行-简式贷', total: 788 },
  { title: '工商银行-小微创业贷', total: 682 },
  { title: '江苏银行-小微e贷', total: 582 },
  { title: '工商银行-小企业周转贷款', total: 520 },
  { title: '江苏银行-快易贷', total: 296 },
  { title: '民生银行-商贷通', total: 279 },
  { title: '海安农商银行-致富贷', total: 265 },
];
// for (let i = 0; i < 7; i += 1) {
