      ...
      <PageHeaderWrapper>
        <Card bordered={false} className={styles.content}>
          ...
          <div className={styles.box}>
            ...
            <Row>
              <Col span={24}>
                <FormItem {...halfItemLayout} label="投诉机构账号">
                  913101103246443123
                </FormItem>
              </Col>
            </Row>
            <Row>
              <Col span={24}>
                <FormItem {...halfItemLayout} label="投诉机构联系人">
                  江苏银行
                </FormItem>
              </Col>
            </Row>
            <Row>
              <Col span={24}>
                <FormItem {...halfItemLayout} label="投诉机构联系人电话">
                  13812345678
                </FormItem>
              </Col>
            </Row>
            ...
            <Row>
              <Col span={24}>
                <FormItem {...halfItemLayout} label="被投诉企业">
                  {detailData.qy}
                </FormItem>
              </Col>
            </Row>
            <Row>
              <Col span={24}>
                <FormItem {...halfItemLayout} label="被投诉企业账号">
                  913101103246443123
                </FormItem>
              </Col>
            </Row>
