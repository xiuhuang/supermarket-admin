  ...
  columns: StandardTableColumnProps[] = [
    {
      title: '投诉编号',
      dataIndex: 'no',
      render: (v, r) => <Link to={`/ga/complaint/institution/detail/${v}`}>{v}</Link>,
    },
    {
      title: '投诉机构名称',
      dataIndex: 'jg',
    ...
    },
    {
      ...
      render: (text, record) => (
        <Fragment>
          {record.status === 0 && (
            <Link to={`/ga/complaint/institution/detail/${record.no}?t=e`}>回复</Link>
          )}
